...
def main():
    ...
    dao.new_user('john.doe@email.com', 'john', 'John', 'Doe', 'johnDoe.jpeg')
    dao.new_user('jane.smith@email.com', 'jane', 'Jane', 'Smith', 'janeSmith.jpeg')
    dao.new_user('robert.johnson@email.com', 'robert', 'Robert', 'Johnson', 'robertJohnson.jpeg')
    dao.new_user('emily.williams@email.com', 'emily', 'Emily', 'Williams', 'emilyWilliams.jpeg')
    dao.new_user('michael.brown@email.com', 'michael', 'Michael', 'Brown', 'michaelBrown.jpeg')
